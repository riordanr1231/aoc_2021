...
func (b *Board) Create(board string) *Board {
	...
	// diagonal
	// b.lines[10] = []string{matrix[0][0], matrix[1][1], matrix[2][2], matrix[3][3], matrix[4][4]}
	// b.lines[11] = []string{matrix[4][0], matrix[3][1], matrix[2][2], matrix[1][3], matrix[0][4]}
